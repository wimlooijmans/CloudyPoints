...
class CityscapesDataset(Dataset):
    def __init__(self, path_data, split, augmentation=None):
        ...
        self.all_path_images = [
            img for img in self.path_images.iterdir() if img.suffix == ".png"
        ]
    ...
    def __getitem__(self, idx):
        ...
        name = path_image_i.stem[
            :-11
        ]  # discard last 11 letters because these are '_left_image'
